...
public class PlayPingPong implements Runnable {
    ...
    public void run() {
        ...
        PingPongThread pingPongThreads[] = new PingPongThread[MAX_PING_PONG_THREADS];
    ...
    private void makePingPongThreads(String syncMechanism,
        ...
        if (syncMechanism.equals("SEMA")) {
            ...
            // "ping" and "pong" in the correct alternating order.
            PingPongThreadMonObj.BinarySemaphore pingSema = new PingPongThreadMonObj.BinarySemaphore(true); // Start out unlocked.
