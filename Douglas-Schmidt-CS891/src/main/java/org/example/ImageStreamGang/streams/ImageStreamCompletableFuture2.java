...
import static org.example.ImageStreamGang.utils.StreamOfFuturesCollector.toFuture;
        ...
        return imageFuture
            ...
            .thenCompose(image -> mFilters
                         ...
                         .map(filter -> CompletableFuture
                              ...
                              .supplyAsync(() -> makeFilterDecoratorWithImage(filter, image).run(), getExecutor()))
