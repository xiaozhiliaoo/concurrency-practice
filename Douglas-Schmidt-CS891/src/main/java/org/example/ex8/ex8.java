...
import static org.example.ex8.FuturesCollector.toFuture;
...
//        testFractionMultiplications2();
    ...
    private static void testFractionMultiplicationSupplyAsync() {
        StringBuilder sb = new StringBuilder(">> Calling testFractionMultiplicationSupplyAsync()\n");
        ...
        // Print the result, blocking until it's ready.
        sb.append("supplyAsync() result = " + future.join().toMixedString());
        display(sb.toString());
    }
    ...
    /*private static void testFractionMultiplicationCompleteAsync() {
        ...
        future.thenRun(() -> sb.append("     completeAsync() result = "));
    ...
    private static void testFractionMultiplications1() {
        StringBuffer sb = new StringBuffer(">> Calling testFractionMultiplications1()\n");
