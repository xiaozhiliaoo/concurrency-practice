package org.example.SearchStreamGang;


import org.example.SearchStreamGang.streamgangs.*;
...
import org.example.SearchStreamGang.utils.TestDataFactory;
...
public class SearchStreamGangTest {
    ...
    public static void main(String[] args) {
        ...
        List<String> phaseList = TestDataFactory.getPhraseList(sPHASE_LIST_FILE);

        // Create/run StreamGangs to search for the phases to find.
        runTests(phaseList, inputData);
    ...
    private static void runTests(List<String> phaseList,
        ...
        for (TestsToRun test : TestsToRun.values()) {
            ...
            // SearchStreamGang.
            SearchStreamGang streamGang = makeSearchStreamGang(phaseList, inputData, test);
    ...
    private static void warmUpForkJoinPool(List<String> phraseList,
        ...
        SearchStreamGang streamGang = new SearchStreamGang(phraseList, inputData);
