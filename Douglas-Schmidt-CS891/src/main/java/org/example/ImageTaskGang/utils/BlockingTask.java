...
/**
 * An adapter class that makes it easy to integrate blocking Runnables
 * and Suppliers with the common Java fork/join thread pool.  This
 * class is a variant of the one described at
