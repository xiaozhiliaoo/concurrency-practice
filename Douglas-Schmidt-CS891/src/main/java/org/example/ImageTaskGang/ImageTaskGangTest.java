package org.example.ImageTaskGang;

import org.example.ImageTaskGang.filters.Filter;
import org.example.ImageTaskGang.filters.GrayScaleFilter;
import org.example.ImageTaskGang.filters.NullFilter;
import org.example.ImageTaskGang.tasks.ImageTaskCompletionServiceCached;
import org.example.ImageTaskGang.tasks.ImageTaskCompletionServiceFixed;
import org.example.ImageTaskGang.tasks.ImageTaskGang;
...
import static org.example.ImageTaskGang.utils.FileAndNetUtils.deleteAllFiles;
    ...
    private static ImageTaskGang makeImageTaskGang(Filter[] filters,
        ...
        switch (choice) {
            case EXECUTOR_COMPLETION_SERVICE_CACHED:
                return new ImageTaskCompletionServiceCached(filters, urlLists);
            case EXECUTOR_COMPLETION_SERVICE_FIXED:
                return new ImageTaskCompletionServiceFixed(filters, urlLists);
        }
