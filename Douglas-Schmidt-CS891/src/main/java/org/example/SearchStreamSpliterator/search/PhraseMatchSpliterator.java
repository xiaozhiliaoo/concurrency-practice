package org.example.SearchStreamSpliterator.search;
...
import static org.example.SearchStreamSpliterator.search.SearchResults.Result;
 ...
 */
public class PhraseMatchSpliterator implements Spliterator<Result> {
    /**
     * The input string.
     */
