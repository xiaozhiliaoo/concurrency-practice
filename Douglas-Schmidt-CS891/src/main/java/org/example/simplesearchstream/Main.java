package org.example.simplesearchstream;


import org.example.simplesearchstream.search.SearchResults;
import org.example.simplesearchstream.search.WordSearcher;
import org.example.simplesearchstream.utils.TestDataFactory;
...
public class Main {
     ...
     * musical.
     */
    private static final String sINPUT_FILE = "do-re-mi.txt";

    /**
     * A list of words to search for the input file.
     */
    private static final String sWORD_LIST_FILE = "wordList.txt";
    ...
    static public void main(String[] args) {
        ...
        // do-re-mi song.
        String inputString = TestDataFactory.getInput(sINPUT_FILE, "@").get(0);

        // Get the list of words to find.
        List<String> wordsToFind = TestDataFactory.getWordList(sWORD_LIST_FILE);
